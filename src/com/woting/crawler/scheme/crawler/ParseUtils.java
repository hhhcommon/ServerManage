...
public abstract class ParseUtils {
	...
	public static int getType(String href){
		...
		if(href.startsWith("http://www.ximalaya.com/dq/all/")) return 5;
		if(href.startsWith("http://www.ximalaya.com") && href.contains("album")) return 6;
		if(href.startsWith("http://www.ximalaya.com") && href.contains("sound")) return 7;
		return 0;
	}
}
