...
public class ImageUtils {
    ...
    public static Map<String, Object> compareImageHashCode(String url, ImageHashService iHashService) {
...
//				out.close();
				ImageIO.write(image, /*"GIF"*/ formatName /* format desired */ , new File(imgPath) /* target */ );
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
